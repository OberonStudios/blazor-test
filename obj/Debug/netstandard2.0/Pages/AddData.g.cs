...
namespace BlazorApp1.Pages
{
    ...
    public class AddData : Microsoft.AspNetCore.Blazor.Components.BlazorComponent
    {
        ...
        protected override void BuildRenderTree(Microsoft.AspNetCore.Blazor.RenderTree.RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(17, "class", "rounded-circle" + " img-fluid" + " " + (hidden));
            ...
            builder.AddMarkupContent(49, "<small id=\"emailHelp\" class=\"form-text text-muted\">Our company doesn\'t share data with anyone else... I promise</small>\n      ");
            builder.CloseElement();
            builder.AddContent(50, "\n    ");
            builder.CloseElement();
            builder.AddContent(51, "\n    ");
            builder.OpenElement(52, "div");
            builder.AddAttribute(53, "class", "btn-group btn-group-toggle");
            builder.AddAttribute(54, "data-toggle", "buttons");
            builder.AddContent(55, "\n      ");
            builder.OpenElement(56, "button");
            builder.AddAttribute(57, "class", "btn btn-primary");
            builder.AddAttribute(58, "onclick", Microsoft.AspNetCore.Blazor.Components.BindMethods.GetEventHandlerValue<Microsoft.AspNetCore.Blazor.UIMouseEventArgs>(addPerson));
            builder.AddContent(59, "Create");
            builder.CloseElement();
            builder.AddContent(60, "\n      ");
            builder.OpenElement(61, "button");
            builder.AddAttribute(62, "class", "btn btn-danger");
            builder.AddAttribute(63, "onclick", Microsoft.AspNetCore.Blazor.Components.BindMethods.GetEventHandlerValue<Microsoft.AspNetCore.Blazor.UIMouseEventArgs>(goHome));
            builder.AddContent(64, "Home");
            builder.CloseElement();
